...
```bash
# Run all tests
cd services/telegram-bot && pytest -v
...
### Run Command
```bash
cd services/telegram-bot && pytest tests/test_[name].py -v
```
...
---
*Tests generated locally on GPU server (qwen2.5-coder:32b) - no cloud tokens used*
```
...
- files_to_test: ["services/telegram-bot/src/email_handler.py"]
- test_type: "unit"
- framework: "pytest"
- coverage_target: 85%
